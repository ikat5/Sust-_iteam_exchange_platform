        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-5">
              ...
              <span className="text-2xl font-bold text-foreground">SUST Exchange</span>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-5">Quick Links</h3>
            <ul className="space-y-3">
              ...
              <li><Link to="/sell" className="text-muted-foreground hover:text-primary transition-colors">Sell Product</Link></li>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-5">Categories</h3>
            <ul className="space-y-3">
              <li><Link to="/category/Electronics" className="text-muted-foreground hover:text-primary transition-colors">Electronics</Link></li>
              <li><Link to="/category/Books" className="text-muted-foreground hover:text-primary transition-colors">Books</Link></li>
              <li><Link to="/category/Cycles" className="text-muted-foreground hover:text-primary transition-colors">Cycles</Link></li>
              <li><Link to="/category/Furniture" className="text-muted-foreground hover:text-primary transition-colors">Furniture</Link></li>
              <li><Link to="/category/Clothing" className="text-muted-foreground hover:text-primary transition-colors">Clothing</Link></li>
              <li><Link to="/category/Others" className="text-muted-foreground hover:text-primary transition-colors">Others</Link></li>
            </ul>
          </div>
        </div>
